...
const DetailsInformation = ({ id }: { id: string }) => {
  return (
    <div className="space-y-space12">
      <div className="space-y-space12">
        <Text title="Customer Info" className='font-semibold text-lg border-b border-color pb-space8' />

        <Card className='p-space12 space-y-space12'>
          <Text title='Delivery address' className='font-semibold' />

          <Text title={`Address: Gazipur Sadar, Dhaka, Dhaka 1200`} variant='secondary' />
          ...
          <div className="flex items-center gap-space12">
            ...
            <div className="max-w-max py-space6 pl-space6 pr-space8 rounded-full flex items-center background border border-color">
              <FallBackImage src='' fallback='M' className='h-space24 w-space24 mr-space8' />
      ...
      <div className="grid sm:grid-cols-2 gap-space16">
        ...
        <div className="space-y-space12">
          <Text title="Order info" className='font-semibold text-lg border-b border-color pb-space8' />
          ...
          <Card className='p-space12 space-y-space12'>
            ...
            <Text title={`Order no:  #12120102-123456`} className='font-semibold' />

            <Text title={`Delivery type:  Cash on Delivery`} variant='secondary' />
        ...
        <div className="space-y-space12">
          <Text title="Charges" className='font-semibold text-lg border-b border-color pb-space8' />

          <Card className='p-space12 space-y-space12'>
            <Text title={`Total Price:  ৳ ১২,০০০`} className='font-semibold' />
            <Text title={`Discount:  ৳ ১২,০০০`} className='font-semibold' variant='error' />
