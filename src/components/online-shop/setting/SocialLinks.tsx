    ...
    return (
        <div className='w-full space-y-space16'>
            <Card className='p-space12 space-y-space12 pb-space32'>
                ...
                <Text className='font-medium text-sm' variant='secondary' title="your customer can follow through social media" />

                <div className="flex gap-space16">
                    <Image src="/images/social/facebook.svg" alt='' height={64} width={64} />
                    <Image src="/images/social/instagram.svg" alt='' height={64} width={64} />
                    <Image src="/images/social/youtube.svg" alt='' height={64} width={64} />
                </div>

                <div className="space-y-space6">
                    <Label htmlFor='facebook' className='font-medium text-sm'>Facebook</Label>
                ...
                <div className="space-y-space6">
                    <Label htmlFor='Youtube' className='font-medium text-sm'>Youtube</Label>
