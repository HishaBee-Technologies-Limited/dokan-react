    ...
    return (
        <div className="border-b border-dashed border-color pt-space8 pb-space12 space-y-space6 ">
            <div className="flex justify-between gap-space10 items-start">
                ...
                <Button type='button' size={'icon'} variant={'danger'} ><CancelIcon /></Button>
            </div>
            ...
            <div className="flex gap-space12">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className='space-y-0 w-full'>
                            <FormLabel>Quantity <span className="text-error-100">*</span> </FormLabel>
                            <FormControl>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className='space-y-0 w-full'>
                            <FormLabel>Unit Price <span className="text-error-100">*</span> </FormLabel>
                            <FormControl>
