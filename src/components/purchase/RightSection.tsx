        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="lg:pl-space12 lg:border-l border-color h-full lg:w-8/12 space-y-space16">
                <ScrollArea className='w-full h-[calc(100%-30rem)] overflow-y-scroll shadow p-space8 pt-0 relative rounded-md background'>
                    <Text title='Products Added for Purchase' className='font-semibold sticky top-0 z-20 background pt-space8' />
                    ...
                    <Card className="p-space8 py-space12 rounded-none space-y-space8">
                        ...
                        <div className="flex gap-space8 sm:gap-space16">
                            <Button
                                ...
                                type="submit"
                                className="w-full"
                                onClick={() => handleDrawerOpen({ open: true, header: SellEnum.CONFIRM_PAYMENT })}
                            >
                            ...
                            <Button
                                ...
                                type="submit"
                                className="w-full"
                                onClick={() => handleDrawerOpen({ open: true, header: SellEnum.MONEY_GIVEN_ENTRY })}
                            >
                            ...
                            <Button
                                ...
                                type="submit"
                                className="w-full"
                                onClick={() => handleDialogOpen({ open: true, header: SellEnum.QR_CODE })}
                            >
