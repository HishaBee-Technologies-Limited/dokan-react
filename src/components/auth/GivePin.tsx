...
const GivePin = () => {
    ...
    return (
        <div>
            <Text title='Set up a PIN' className='text-[2.8rem] font-semibold mb-space16' />
            <Text title='Set up a 5 digit PIN number to keep your account secure.' variant='secondary' className='mb-space32' />
                ...
                <div className="relative">
                    ...
                    >
                        {showPin ? (
                            ...
                            <Icon icon="ant-design:eye-invisible-twotone" width={29} height={30} />
                        )}
                    </button>
                </div>
            </div>

            <Button className='w-full' disabled={pin.length !== 5}>Confirm</Button>
            <Button className='w-full' variant={'transparent'} >Forgot pin?</Button>
        </div>
    )
}
