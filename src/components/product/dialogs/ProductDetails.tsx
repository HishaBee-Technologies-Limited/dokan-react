...
import { AddIcon, DeleteIcon, EditIcon, MoreVertIcon } from '../../common/icons'
            ...
            <div className="px-space16 space-y-space16 py-space16">
                <div className="border-b border-color pb-space16 flex justify-between gap-space16">
                    <div className="flex items-center gap-space8">
                        ...
                        <article className="space-y-space4">
                            <Text title={`Parachute SkinPure Orange Brightening Face Wash Anti Pimple 100 gm`} className='text-sm font-semibold' />
                            <Text title={`৳ 1200`} variant='secondary' className='text-sm font-semibold' />
                        </article>
                    </div>
                        ...
                        <DropdownMenuContent align='end' side='bottom' className="w-56">
                            <DropdownMenuItem asChild >
                                <Button
                                    ...
                                    onClick={() => handleDrawerOpen({ open: true, header: ProductEnum.EDIT_PRODUCT })}
                            ...
                            <DropdownMenuItem asChild >
                                <Button
                                    ...
                                    onClick={() => handleDialogOpen({ open: true, header: ProductEnum.DELETE_PRODUCT })}
                                >
                                    <DeleteIcon />
                                    Delete
                                </Button>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-space12">
                    <article className="rounded-lg px-space12 py-space8 space-y-space4 bg-primary-10 dark:bg-primary-80">
                        <Text title={`Stock quantity`} variant='secondary' className='font-semibold text-xs uppercase' />
                        <Text title={`111`} className='font-semibold' />
                    </article>
                    <article className="rounded-lg px-space12 py-space8 space-y-space4 bg-primary-10 dark:bg-primary-80">
                        <Text title={`buying price`} variant='secondary' className='font-semibold text-xs uppercase' />
                        <Text title={`৳ 1200  `} className='font-semibold' />
                    </article>
                    <article className="rounded-lg px-space12 py-space8 space-y-space4 bg-primary-10 dark:bg-primary-80">
                        <Text title={`profit`} variant='secondary' className='font-semibold text-xs uppercase' />
                    ...
                    <article className="rounded-lg px-space12 py-space8 space-y-space4 bg-primary-10 dark:bg-primary-80">
                        <Text title={`discount`} variant='secondary' className='font-semibold text-xs uppercase' />
                        <Text title={`--`} className='font-semibold' />
                    </article>
                    <article className="rounded-lg px-space12 py-space8 space-y-space4 bg-primary-10 dark:bg-primary-80">
                        <Text title={`category`} variant='secondary' className='font-semibold text-xs uppercase' />
                        <Text title={`111`} className='font-semibold' />
                    </article>
                </div>

                <Text title='More details of product' className='uppercase text-sm font-semibold' />

                <div className="grid grid-cols-2 sm:grid-cols-3 gap-space12 pb-space16 border-b border-color">
                    <article className="rounded-lg px-space12 py-space8 space-y-space4 bg-primary-10 dark:bg-primary-80">
                        <Text title={`vat (%)`} variant='secondary' className='font-semibold text-xs uppercase' />
                        <Text title={`111`} className='font-semibold' />
                    </article>
                    <article className="rounded-lg px-space12 py-space8 space-y-space4 bg-primary-10 dark:bg-primary-80">
                        <Text title={`Warranty`} variant='secondary' className='font-semibold text-xs uppercase' />
                        <Text title={`--`} className='font-semibold' />
                    </article>
                    <article className="rounded-lg px-space12 py-space8 space-y-space4 bg-primary-10 dark:bg-primary-80">
                        <Text title={`low stock alert level`} variant='secondary' className='font-semibold text-xs uppercase' />
                        <Text title={`12`} className='font-semibold' />
                    </article>
                </div>

                <Text title='Product details' className='uppercase text-sm font-semibold' />
            ...
            <DialogFooter className='flex flex-col gap-space16 rounded-b-lg'>
                ...
                <div className="flex gap-space12">
                    <Button
                        ...
                        onClick={() => handleDialogOpen({ open: true, header: ProductEnum.SHARE_PRODUCT })}
                    >
                    ...
                    <Button
                        variant={'secondary'}
                        className='w-full !font-medium'
                        onClick={() => handleDialogOpen({ open: true, header: ProductEnum.PRODUCT_HISTORY })}
                    >
                        <HistoryIcon />
                        Product History
                    </Button>
