    ...
    return (
        <div className='py-space16 px-space16 pb-space32 space-y-space16'>
            ...
            <div className="grid grid-cols-2 gap-space16">
                <Button variant={'transparent'} className='bg-primary-10 hover:bg-primary-10 dark:bg-primary-80 dark:hover:bg-primary-80'>
            ...
            <Button variant={'transparent'} className='w-full bg-primary-10 hover:bg-primary-10 dark:bg-primary-80 dark:hover:bg-primary-80 justify-between'>
            ...
            <Text title='Share Link' className='text-lg font-semibold py-space16 text-center' />
            ...
            <div className="flex flex-wrap items-center gap-space24 justify-around">
                ...
                <div className="space-y-space8 text-center">
                    <Button variant={'transparent'} size={'icon'}>
                        <Image src={'/images/social/messenger.svg'} alt='' height={54} width={54} />
                    </Button>
                    <Text title='Email' className='text-lg font-semibold' />
                </div>
                <div className="space-y-space8 text-center">
                    <Button variant={'transparent'} size={'icon'}>
                        <Icon icon="ic:sharp-whatsapp" height={54} width={54} color='green' />
                    </Button>
                    <Text title='Whatsapp' className='text-lg font-semibold' />
                </div>
                <div className="space-y-space8 text-center">
                    <Button variant={'transparent'} size={'icon'}>
                        <Icon icon="icon-park-outline:application-menu" height={54} width={54} color='blue' />
                    </Button>
