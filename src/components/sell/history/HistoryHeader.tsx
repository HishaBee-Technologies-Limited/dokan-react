...
const HistoryHeader = () => {
    ...
    return (
        <div className='flex justify-between items-center flex-wrap gap-space16'>
            ...
            <Button variant={'secondary'} className='sm:hidden'><DownloadIcon />PDF Download</Button>
            ...
            <div className="flex flex-wrap gap-space8 sm:gap-space12">
                ...
                <Button variant={'secondary'} className='hidden sm:flex'><DownloadIcon />PDF Download</Button>
            </div>
        </div>
    )
}
