...
import { DrawerFooter } from "../../common/Drawer";
import {
  Select,
  SelectContent,
  SelectItem,
              ...
              <FormControl>
                ...
                >
                  {cashType.map((item) => (
                    <FormItem
                      key={item.value}
                      className={`flex rounded-md border border-color py-space8 px-space12 gap-space8 w-full ${
                        form.watch("cash_type") === item.value
                          ? "background border-primary-100 dark:border-primary-80"
