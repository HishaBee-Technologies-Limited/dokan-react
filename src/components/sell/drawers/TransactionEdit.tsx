...
const TransactionEdit = () => {
    ...
    return (
        <div className="space-y-space12">
            ...
            <Text title="Payable Amount  ৳ 12,০০০" className="text-lg font-medium bg-primary-10 dark:bg-primary-80 text-center rounded-md py-space8" />
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-space12">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>Amount <span className="text-error-100">*</span> </FormLabel>
                                <FormControl>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>Name <span className="text-error-100">*</span> </FormLabel>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>Number <span className="text-error-100">*</span> </FormLabel>
                                <FormControl>
                                ...
                                <FormItem className="w-[4.4rem] h-full">
                                    <FormControl>
                                        <>
                                            ...
                                            <Label htmlFor="image" className="cursor-pointer border border-color w-full h-full rounded-md flex items-center justify-center dark:bg-primary-100 dark:text-primary-40">
                    ...
                    <DrawerFooter height="14rem" className="flex-col !gap-space12">
                        <div className="flex items-center gap-space8 justify-center">
                            ...
                            <Text variant="success" className="text-sm font-medium flex items-center gap-space4 bg-success-10 dark:bg-primary-80 py-space4 px-space12 rounded-full">
