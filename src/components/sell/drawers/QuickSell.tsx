                    ...
                    render={({ field }) => (
                        ...
                        <FormItem className="space-y-3">
                            ...
                            <FormControl>
                                ...
                                >
                                    {cashType.map((item) => (
                                        <FormItem key={item.value} className={`flex rounded-md border border-color py-space8 px-space12 gap-space8 w-full ${form.watch('cash_type') === item.value ? 'background border-primary-100 dark:border-primary-80' : 'bg-primary-10 dark:bg-primary-70'}`}>
                                            <FormControl>
