            ...
            <div className="h-full flex flex-col gap-space24">
                <div className="flex justify-between gap-space16">
                    <Form {...form} >
                        <form onSubmit={form.handleSubmit(onSubmit)} className="">
                            ...
                            <div className="flex items-center gap-space12">
                                ...
                                <Button variant={'secondary'} className="!h-[4.4rem] !px-space12">
                                    <AddIcon />
                                </Button>
                            </div>
                        </form>
                    ...
                    <div className="flex flex-col items-end gap-space4">
                        <Text variant="success" className="text-sm font-medium flex items-center gap-space4 bg-success-20 dark:bg-primary-80 py-space4 px-space12 rounded-full uppercase">
                    ...
                    <div className="space-y-space8">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-space8">
                            {Array(8).fill(0).map((_, i) => (
                                <Card key={i} className="px-space12 py-space12 flex justify-center items-center gap-space8">
