...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-space8 rounded-md border border-primary-10 dark:border-primary-80 dark:bg-primary-100", className)}
      classNames={{
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft className="h-[2rem] w-[2rem]" />,
        IconRight: ({ ...props }) => <ChevronRight className="h-[2rem] w-[2rem]" />,
      }}
      {...props}
    />
  )
