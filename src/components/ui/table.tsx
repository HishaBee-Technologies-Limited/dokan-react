...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto min-w-[70rem]">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b [&_tr]:border-primary-10 [&_tr]:dark:border-primary-80", className)} {...props} />
))
