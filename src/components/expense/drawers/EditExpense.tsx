...
const EditExpense = () => {
    ...
    const handleAddNewCategory = useExpenseStore((state) => state.setExpenseDialogState)
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-space12">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Category Name <span className="text-error-100">*</span></FormLabel>
                            ...
                            <FormItem className="w-[4.4rem] h-full">
                                <FormControl>
                                    <>
                                        ...
                                        <Label htmlFor="image" className="cursor-pointer border border-color w-full h-full rounded-md flex items-center justify-center">
                ...
                <DrawerFooter>
                    <Button variant={'secondary'} onClick={() => closeDrawer({ open: false })} className="w-full">Cancel</Button>
