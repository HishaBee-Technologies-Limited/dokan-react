        ...
        <div>
            ...
            <WrapperOddList className='space-y-space8'>
                {Array(20).fill(0).map((_, i) => (
                    <div key={i} className="border border-color rounded-md p-space12 flex items-center justify-between gap-space12">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button size={'icon'} variant={'transparent'}> <MoreVertIcon /> </Button>
                            </DropdownMenuTrigger>
                            ...
                            <DropdownMenuContent align='end' side='bottom' className="w-56 ">
                                <DropdownMenuItem asChild >
                                    <Button
                                        ...
                                        onClick={() => setExpenseDialog({ open: true, header: ExpenseEnum.EDIT_CATEGORY })}
                                    >
                                        <EditIcon />
                                        Edit
                                    </Button>
                                ...
                                <DropdownMenuItem asChild >
                                    <Button
                                        ...
                                        onClick={() => setExpenseDialog({ open: true, header: ExpenseEnum.DELETE_EXPENSE_CATEGORY })}
                                    >
                                        <DeleteIcon />
                                        Delete
                                    </Button>
            ...
            <DrawerFooter>
                <Button
                    className='w-full'
                    onClick={() => setExpenseDialog({ open: true, header: ExpenseEnum.ADD_NEW_CATEGORY })}
                >
                    <AddIcon />
                    নতুন ক্যাটাগরি
                </Button>
