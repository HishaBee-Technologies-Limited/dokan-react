    ...
    return (
        <div className='relative'>
            <article className="px-space16 py-space16 space-y-space16">
                <Text title='Are you sure you want to Delete this category?' className='text-xl font-semibold' />
                <Text title='You will not able to save further expense on this category' variant='secondary' className='text-lg' />
            </article>
