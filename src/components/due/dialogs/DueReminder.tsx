            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-full">
                <div className="w-full space-y-space16 py-space16 px-space12 sm:px-space16">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                                <FormLabel>Want to receive due reminder notifications?</FormLabel>
                                <FormControl>
                                    <Switch
                                        checked={field.value}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                                <FormLabel>Do you want to send reminder SMS to customers ?</FormLabel>
                                <FormControl>
                                    <Switch
                                        checked={field.value}
                                        onCheckedChange={field.onChange}
                ...
                <DialogFooter className="flex-col !gap-space12">
                    <Text variant="success" className="max-w-max mx-auto mb-space12 text-sm font-medium flex items-center gap-space4 bg-success-10 dark:bg-primary-80 py-space4 px-space12 rounded-full">
