                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    ...
                    <Card className='space-y-space12 px-space16 py-space16'>
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col items-center justify-center gap-space16 py-space12">
                                    <div className="h-[10rem] w-[10rem] bg-primary-5 dark:bg-primary-80 border border-color rounded-full flex items-center justify-center">
                                        <Image src={`/images/update_shop.svg`} alt='' height={54} width={54} />
                                    </div>

                                    <label className="cursor-pointer">
                                        <input type="file" className="hidden" {...field} />

                                        <p className="text-blue-600 text-sm font-medium text-center">Add a logo of your Shop</p>
                                    </label>
                                </FormItem>
                            )}
                        />
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Shop Name <span className="text-error-100">*</span> </FormLabel>
                                    <FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Shop Type <span className="text-error-100">*</span></FormLabel>
                            ...
                            render={({ field }) => (
                                ...
                                <FormItem className="space-y-3">
                                    ...
                                    <FormControl >
                                        ...
                                        >
                                            {cashType.map((item) => (
                                                <FormItem key={item.value} className={`flex rounded-lg border border-color py-space12 px-space12 gap-space8 w-full`}>
                                                    <FormControl>
                        ...
                        <Text title={`This number will be visible to everyone and they will contact you through this number. Alternatively provide Helpline number if you have any.`} variant='secondary' />
