    ...
    return (
        <div className="md:flex items-start gap-space16 w-full h-full">
            <ScrollArea className='space-y-space24 max-w-[54rem] w-full h-full overflow-y-scroll pr-space16 mx-auto'>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-space12 pb-space12">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex items-center justify-between gap-space24 py-space24">
                                    <FormLabel>
                                        <Text title="Language" className="font-semibold mb-space8" />
                                        <Text title="Printer Language show" className="font-medium text-sm" variant="secondary" />
                                    </FormLabel>
                                    <FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex items-center justify-between gap-space24 py-space24 border-y border-color">
                                    <FormLabel>
                                        <Text title="Printer size" className="font-semibold mb-space8" />
                                        <Text title="Set the printer paper size" className="font-medium text-sm" variant="secondary" />
                                    </FormLabel>
                                    <FormControl>
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            <FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex items-center justify-between gap-space24 py-space24">
                                    <FormLabel>
                                        <Text title="Printer Text size" className="font-semibold mb-space8" />
                                        <Text title="Set the printer paper size" className="font-medium text-sm" variant="secondary" />
                                    </FormLabel>
                                    <FormControl>
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            render={({ field }) => (
                                <FormItem className="flex items-center justify-between gap-space24 py-space24 border-y border-color">
                                    <FormLabel>
                                        ...
                                        <Text title="Turn ON/OFF to Show/Hide QR Code on receipt" className="font-medium text-sm" variant="secondary" />
                                    </FormLabel>
                                    <FormControl>
                                        <Switch
                                            checked={field.value}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col gap-space12 py-space24">
                                    <FormLabel>
                                        <Text title="Additional Text" className="font-semibold mb-space8" />
                                        <Text title="Write here to include text in the receipt" className="font-medium text-sm" variant="secondary" />
                                    </FormLabel>
                                    <FormControl>
                                        <Input placeholder="additional text will be  given here" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
