    ...
    <div className='w-full h-full flex flex-col gap-space16'>
      <div className="flex items-center justify-between gap-space16 flex-wrap">
        <article className="space-y-space4">
          ...
          <Text title={shopInfo?.data?.data?.overview?.address} className='text-sm' variant='secondary' />
        </article>
      ...
      <div className="flex justify-center flex-wrap gap-space12">
        <Card className="w-full max-w-[14rem] h-[12rem] flex flex-col items-center justify-center gap-space8">
          ...
          <Text title={shopInfo?.data?.data?.overview?.active_orders?.toString()} className='font-bold text-xl' />
        </Card>

        <Card className="w-full max-w-[14rem] h-[12rem] flex flex-col items-center justify-center gap-space8">
          <Text title="Processing" variant='secondary' />
          <Text title={shopInfo?.data?.data?.overview?.processing_orders?.toString()} className='font-bold text-xl' />
        </Card>

        <Card className="w-full max-w-[14rem] h-[12rem] flex flex-col items-center justify-center gap-space8">
          <Text title="Delivered" variant='secondary' />
          <Text title={shopInfo?.data?.data?.overview?.delivered_orders?.toString()} className='font-bold text-xl' />
        </Card>

        <Card className="w-full max-w-[14rem] h-[12rem] flex flex-col items-center justify-center gap-space8">
          <Text title="Total Income" variant='secondary' />
          <Text title={shopInfo?.data?.data?.overview?.total_earning?.toString()} className='font-bold text-xl' />
        </Card>

        <Card className="w-full max-w-[14rem] h-[12rem] flex flex-col items-center justify-center gap-space8">
          <Text title="Online Product" variant='secondary' />
          <Text title={shopInfo?.data?.data?.overview?.online_products?.toString()} className='font-bold text-xl' />
        </Card>
      </div>
