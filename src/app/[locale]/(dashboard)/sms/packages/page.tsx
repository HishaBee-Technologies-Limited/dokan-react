        ...
        <div className='h-full overflow-y-scroll space-y-space24'>
            ...
            <Card className='p-space8 sm:p-space16 shadow-sm flex items-center gap-space8 sm:gap-space16'>
                ...
                <article className="space-y-space16 w-full">
                    ...
                    <Text variant='secondary' title='হিসাবী থেকে প্রতি মাসে আপনাকে ৩০ টি  করে এস এম এস ফ্রি দেয়া হয় । যা আপনি মার্কেটিং অথবা বিক্রির রিসিপ্ট পাঠাতে ব্যবহার করতে পারবেন । এর থেকে বেশি এস এম এস যদি প্রয়োজন হয় তাহলে আপনার চাহিদা অনুযায়ী সাশ্রয়ী প্যাকেজ কিনে নিতে পারবেন এখান থেকে ।' className='md:w-3/4' />
                </article>

            </Card>
            <div className="grid sm:grid-cols-2 gap-space12">
                {Array(4).fill(0).map((_, i) => (
                    <Card key={'package' + i} className='py-space8 sm:py-space12 px-space12 sm:px-space16 shadow-md flex'>
                        <Text variant='success' className='text-center pr-space24 border-r border-color min-w-max'>
                        ...
                        <div className="w-full flex justify-between gap-space12 items-center pl-space16">
                            <article>
                                <Text title={`৳ 11.5`} className='text-lg font-semibold mb-space12' />
