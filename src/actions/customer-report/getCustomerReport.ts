...
import { ICustomerReportsResponse } from '@/types/CustomerReport';
...
export const getCustomerReport = async (
  ...
  try {
    ...
    const res = await authApi.get(`/overview/customer?${params}`);
    ...
    if (res.ok) {
      return {
        ...
        data: data as ICommonGetResponse<ICustomerReportsResponse>,
      };
    }
    if (!res.ok) {
